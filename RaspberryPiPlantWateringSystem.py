...
def background():
    ...
    # It changes the global variable setup to only run once and then begins monitoring soil moisture
    global setup
...
def create_table(channel):
    ...
    if 0 <= channel <= 7:
        ...
        print("The channel specified ({}) is outside the valid range (0 to 7)".format(
            channel))
